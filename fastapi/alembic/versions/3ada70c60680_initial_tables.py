...
def upgrade() -> None:
    ...
    sa.Column('environment_code', sqlmodel.sql.sqltypes.AutoString(length=2), nullable=False),
    ...
    op.create_table('experiment_areaofscience',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('description', sa.TEXT(), nullable=True),
    sa.Column('is_deleted', sa.Boolean(), nullable=True),
    ...
    op.create_index(op.f('ix_experiment_areaofscience_is_deleted'), 'experiment_areaofscience', ['is_deleted'], unique=False)
    op.create_table('experiment_datasensitivity',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('description', sa.TEXT(), nullable=True),
    sa.Column('is_deleted', sa.Boolean(), nullable=True),
    ...
    op.create_index(op.f('ix_experiment_datasensitivity_is_deleted'), 'experiment_datasensitivity', ['is_deleted'], unique=False)
    op.create_table('experiment_fundingsource',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    op.create_index(op.f('ix_experiment_fundingsource_is_deleted'), 'experiment_fundingsource', ['is_deleted'], unique=False)
    op.create_table('experiment_levelofeffort',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('description', sa.TEXT(), nullable=True),
    sa.Column('is_deleted', sa.Boolean(), nullable=True),
    ...
    op.create_index(op.f('ix_experiment_levelofeffort_is_deleted'), 'experiment_levelofeffort', ['is_deleted'], unique=False)
    op.create_table('experiment_statuses',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('description', sa.TEXT(), nullable=True),
    sa.Column('is_deleted', sa.Boolean(), nullable=True),
    ...
    op.create_index(op.f('ix_experiment_statuses_is_deleted'), 'experiment_statuses', ['is_deleted'], unique=False)
    ...
    op.create_index(op.f('ix_experiment_tags_is_deleted'), 'experiment_tags', ['is_deleted'], unique=False)
    ...
    sa.Column('is_deleted', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['sbda'], ['departments.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_experiment_levelofeffort_is_deleted'), table_name='experiment_levelofeffort')
    op.drop_table('experiment_levelofeffort')
    op.drop_index(op.f('ix_experiment_fundingsource_is_deleted'), table_name='experiment_fundingsource')
    op.drop_table('experiment_fundingsource')
    op.drop_index(op.f('ix_experiment_datasensitivity_is_deleted'), table_name='experiment_datasensitivity')
    op.drop_table('experiment_datasensitivity')
    op.drop_index(op.f('ix_experiment_areaofscience_is_deleted'), table_name='experiment_areaofscience')
